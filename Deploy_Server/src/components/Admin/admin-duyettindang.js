        ...
        />
            <div className='container'>
                <div className='col-md-9 danhsachbdscanduyet'>
                    <h2 style={{marginTop:'10px', fontWeight:'500'}}>QUẢN LÝ TRẠNG THÁI BĐS</h2>
                    <input
                        type="text"
                            ...
                            <tbody>
                                {filteredRealEstates.map(realEstate => (
                                    <tr key={realEstate.id} className='danhsachbdscanduyettheobds'>
                                        ...
                                        <td>
                                            <button onClick={() => handleDelete(realEstate.id)} style={{backgroundColor:'white' ,color: 'red' }} className='fa fa-trash delete'></button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
                    ...
                    {unsavedEstateIds.length > 0 && <button style={{marginTop: '10px', backgroundColor: 'rgb(53, 153, 80)', borderRadius: '8px'}} onClick={handleSaveData} className='save'>Lưu</button>}
                </div>
            </div>
